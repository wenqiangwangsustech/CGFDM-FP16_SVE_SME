...
{																	
	...
	CALCULATE3D( i, j, k, HALO, _nx, HALO, _ny, _nz - HALO, _nz )		
		...
		{										
			...
			zt_x = CJM[pos*CJMSIZE+6]; zt_y = CJM[pos*CJMSIZE+7]; zt_z = CJM[pos*CJMSIZE+8];	
		...
		xi_x = CJM[index*CJMSIZE+0]; xi_y = CJM[index*CJMSIZE+1]; xi_z = CJM[index*CJMSIZE+2];	
		et_x = CJM[index*CJMSIZE+3]; et_y = CJM[index*CJMSIZE+4]; et_z = CJM[index*CJMSIZE+5];	
		zt_x = CJM[index*CJMSIZE+6]; zt_y = CJM[index*CJMSIZE+7]; zt_z = CJM[index*CJMSIZE+8];	

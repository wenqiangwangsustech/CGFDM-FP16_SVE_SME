...
{																	
	...
	svint32_t sveInt32 = svdup_s32_x(p, 0);
	...
	CALCULATE3D_SVE( i, j, k, HALO, _nx, HALO, _ny, HALO, _nz )  
		...
		L_SVE_FP16( Vx_xi, W, 0, WSIZE, FB1, xi ); 				
		L_SVE_FP16( Vy_xi, W, 1, WSIZE, FB1, xi ); 				
		L_SVE_FP16( Vz_xi, W, 2, WSIZE, FB1, xi ); 				
		L_SVE_FP16(Txx_xi, W, 3, WSIZE, FB1, xi ); 				
		L_SVE_FP16(Tyy_xi, W, 4, WSIZE, FB1, xi ); 				
		L_SVE_FP16(Tzz_xi, W, 5, WSIZE, FB1, xi ); 				
		L_SVE_FP16(Txy_xi, W, 6, WSIZE, FB1, xi ); 				
		L_SVE_FP16(Txz_xi, W, 7, WSIZE, FB1, xi ); 				
		L_SVE_FP16(Tyz_xi, W, 8, WSIZE, FB1, xi ); 				

		L_SVE_FP16( Vx_et, W, 0, WSIZE, FB2, et );				
		L_SVE_FP16( Vy_et, W, 1, WSIZE, FB2, et );				
		L_SVE_FP16( Vz_et, W, 2, WSIZE, FB2, et );				
		L_SVE_FP16(Txx_et, W, 3, WSIZE, FB2, et );				
		L_SVE_FP16(Tyy_et, W, 4, WSIZE, FB2, et );				
		L_SVE_FP16(Tzz_et, W, 5, WSIZE, FB2, et );				
		L_SVE_FP16(Txy_et, W, 6, WSIZE, FB2, et );				
		L_SVE_FP16(Txz_et, W, 7, WSIZE, FB2, et );				
		L_SVE_FP16(Tyz_et, W, 8, WSIZE, FB2, et );				

   		L_SVE_FP16( Vx_zt, W, 0, WSIZE, FB3, zt );				
   		L_SVE_FP16( Vy_zt, W, 1, WSIZE, FB3, zt );				
   		L_SVE_FP16( Vz_zt, W, 2, WSIZE, FB3, zt );				
  		L_SVE_FP16(Txx_zt, W, 3, WSIZE, FB3, zt );				
  		L_SVE_FP16(Tyy_zt, W, 4, WSIZE, FB3, zt );				
  		L_SVE_FP16(Tzz_zt, W, 5, WSIZE, FB3, zt );				
  		L_SVE_FP16(Txy_zt, W, 6, WSIZE, FB3, zt );				
  		L_SVE_FP16(Txz_zt, W, 7, WSIZE, FB3, zt );				
  		L_SVE_FP16(Tyz_zt, W, 8, WSIZE, FB3, zt );

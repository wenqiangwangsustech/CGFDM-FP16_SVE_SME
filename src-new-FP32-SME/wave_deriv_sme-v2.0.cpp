...
{																	
	...
	CALCULATE3D_SVE( i, j, k, HALO, _nx, HALO, _ny, HALO, _nz )  
		...
		*/
		...
		/*
		 Vx_xi = svread_hor_za32_f32_m( Vx_xi, pg, 0, 0);
		 Vy_xi = svread_hor_za32_f32_m( Vy_xi, pg, 0, 1);
		 Vz_xi = svread_hor_za32_f32_m( Vz_xi, pg, 0, 2);
		Txx_xi = svread_hor_za32_f32_m(Txx_xi, pg, 0, 3);
		Tyy_xi = svread_hor_za32_f32_m(Tyy_xi, pg, 0, 4);
		Tzz_xi = svread_hor_za32_f32_m(Tzz_xi, pg, 0, 5);
		Txy_xi = svread_hor_za32_f32_m(Txy_xi, pg, 0, 6);
		Txz_xi = svread_hor_za32_f32_m(Txz_xi, pg, 0, 7);
		Tyz_xi = svread_hor_za32_f32_m(Tyz_xi, pg, 0, 8);
		                                                 
		 Vx_et = svread_hor_za32_f32_m( Vx_et, pg, 1, 0);
		 Vy_et = svread_hor_za32_f32_m( Vy_et, pg, 1, 1);
		 Vz_et = svread_hor_za32_f32_m( Vz_et, pg, 1, 2);
		Txx_et = svread_hor_za32_f32_m(Txx_et, pg, 1, 3);
		Tyy_et = svread_hor_za32_f32_m(Tyy_et, pg, 1, 4);
		Tzz_et = svread_hor_za32_f32_m(Tzz_et, pg, 1, 5);
		Txy_et = svread_hor_za32_f32_m(Txy_et, pg, 1, 6);
		Txz_et = svread_hor_za32_f32_m(Txz_et, pg, 1, 7);
		Tyz_et = svread_hor_za32_f32_m(Tyz_et, pg, 1, 8);
		                                                 
		 Vx_zt = svread_hor_za32_f32_m( Vx_zt, pg, 2, 0);
		 Vy_zt = svread_hor_za32_f32_m( Vy_zt, pg, 2, 1);
		 Vz_zt = svread_hor_za32_f32_m( Vz_zt, pg, 2, 2);
		Txx_zt = svread_hor_za32_f32_m(Txx_zt, pg, 2, 3);
		Tyy_zt = svread_hor_za32_f32_m(Tyy_zt, pg, 2, 4);
		Tzz_zt = svread_hor_za32_f32_m(Tzz_zt, pg, 2, 5);
		Txy_zt = svread_hor_za32_f32_m(Txy_zt, pg, 2, 6);
		Txz_zt = svread_hor_za32_f32_m(Txz_zt, pg, 2, 7);
		Tyz_zt = svread_hor_za32_f32_m(Tyz_zt, pg, 2, 8);
		*/
		 ...
		 svwrite_hor_za32_m(0, 0, pg, Vx_xi);
		 svwrite_hor_za32_m(0, 1, pg, Vy_xi);
		 svwrite_hor_za32_m(0, 2, pg, Vz_xi);
		 svwrite_hor_za32_m(0, 3, pg,Txx_xi);
		 svwrite_hor_za32_m(0, 4, pg,Tyy_xi);
		 svwrite_hor_za32_m(0, 5, pg,Tzz_xi);
		 svwrite_hor_za32_m(0, 6, pg,Txy_xi);
		 svwrite_hor_za32_m(0, 7, pg,Txz_xi);
		 svwrite_hor_za32_m(0, 8, pg,Tyz_xi);
		                                   
		 svwrite_hor_za32_m(1, 0, pg, Vx_et);
		 svwrite_hor_za32_m(1, 1, pg, Vy_et);
		 svwrite_hor_za32_m(1, 2, pg, Vz_et);
		 svwrite_hor_za32_m(1, 3, pg,Txx_et);
		 svwrite_hor_za32_m(1, 4, pg,Tyy_et);
		 svwrite_hor_za32_m(1, 5, pg,Tzz_et);
		 svwrite_hor_za32_m(1, 6, pg,Txy_et);
		 svwrite_hor_za32_m(1, 7, pg,Txz_et);
		 svwrite_hor_za32_m(1, 8, pg,Tyz_et);
		                                     
		 svwrite_hor_za32_m(2, 0, pg, Vx_zt);
		 svwrite_hor_za32_m(2, 1, pg, Vy_zt);
		 svwrite_hor_za32_m(2, 2, pg, Vz_zt);
		 svwrite_hor_za32_m(2, 3, pg,Txx_zt);
		 svwrite_hor_za32_m(2, 4, pg,Tyy_zt);
		 svwrite_hor_za32_m(2, 5, pg,Tzz_zt);
		 svwrite_hor_za32_m(2, 6, pg,Txy_zt);
		 svwrite_hor_za32_m(2, 7, pg,Txz_zt);
		 svwrite_hor_za32_m(2, 8, pg,Tyz_zt);
#endif

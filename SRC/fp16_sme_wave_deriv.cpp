...
{																	
	...
	svfloat32_t Vz_xi1; svfloat32_t Vz_et1; svfloat32_t Vz_zt1;
	svfloat32_t Vz_xi2; svfloat32_t Vz_et2; svfloat32_t Vz_zt2;
	...
	svbool_t pg1 = svwhilelt_b32(0, len);
	svbool_t pg2 = svwhilelt_b32(0, len);
	
	svfloat16_t sveArr16;
	svint32_t sveInt32 = svdup_s32_x(pg, 0);

	svfloat32_t Zn, Zm;
	svfloat32_t Z_1, Z0, Z1, Z2, Z3;
	svfloat32_t TMP;

	svuint32_t offset;
	

	svbool_t pgCol0  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 0));
	svbool_t pgCol1  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 1));
	svbool_t pgCol2  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 2));
	svbool_t pgCol3  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 3));
	svbool_t pgCol4  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 4));
	svbool_t pgCol5  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 5));
	svbool_t pgCol6  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 6));
	svbool_t pgCol7  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 7));
	svbool_t pgCol8  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 8));
	svbool_t pgCol9  = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32( 9));
	svbool_t pgCol10 = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32(10));
	svbool_t pgCol11 = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32(11));
	svbool_t pgCol12 = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32(12));
	svbool_t pgCol13 = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32(13));
	svbool_t pgCol14 = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32(14));
	svbool_t pgCol15 = svcmpeq_s32(svptrue_b32(), svindex_s32(0, 1), svdup_s32(15));


	CALCULATE3D_SVE( i, j, k, HALO, _nx, HALO, _ny, HALO, _nz )  
		svzero_za();

		pg1 = svwhilelt_b32( i, _nx - len32 );
		pg2 = svwhilelt_b32( i + len32, _nx );
		index = INDEX( i, j, k );
...
#endif
 		offset = svindex_u32(0, CJMSIZE * sizeof(FLOAT));
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 0]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); xi_x = svcvt_f32_m(TMP, pg, sveArr16 );							
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 1]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); xi_y = svcvt_f32_m(TMP, pg, sveArr16 );							
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 2]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); xi_z = svcvt_f32_m(TMP, pg, sveArr16 );							
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 3]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); et_x = svcvt_f32_m(TMP, pg, sveArr16 );							
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 4]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); et_y = svcvt_f32_m(TMP, pg, sveArr16 );							
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 5]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); et_z = svcvt_f32_m(TMP, pg, sveArr16 );							
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 6]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); zt_x = svcvt_f32_m(TMP, pg, sveArr16 );							
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 7]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); zt_y = svcvt_f32_m(TMP, pg, sveArr16 );							
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+ 8]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); zt_z = svcvt_f32_m(TMP, pg, sveArr16 );							
                                                                                         
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+10]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); mu 		 = svcvt_f32_m(TMP, pg, sveArr16 );
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+11]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); lambda 	 = svcvt_f32_m(TMP, pg, sveArr16 );	
		sveInt32 = svld1sh_gather_offset_s32(pg, (int16_t*)&(CJM[index*CJMSIZE+12]), offset); sveArr16 = svreinterpret_f16( sveInt32 ); buoyancy = svcvt_f32_m(TMP, pg, sveArr16 );							
		//printf("mu = %f, lam = %f, buoyancy = %f\n", mu, lambda, buoyancy );
		...
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW0); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 0]), offset, sveInt32 );
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW1); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 1]), offset, sveInt32 );
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW2); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 2]), offset, sveInt32 );
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW3); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 3]), offset, sveInt32 );
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW4); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 4]), offset, sveInt32 );
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW5); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 5]), offset, sveInt32 );
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW6); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 6]), offset, sveInt32 );
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW7); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 7]), offset, sveInt32 );
		sveArr16 = svcvt_f16_m(sveArr16, pg, HW8); sveInt32 = svreinterpret_s32(sveArr16); svst1h_scatter_offset(pg, (int16_t*)&(h_W[index * WSIZE + 8]), offset, sveInt32 );
	END_CALCULATE3D( )												
}			
